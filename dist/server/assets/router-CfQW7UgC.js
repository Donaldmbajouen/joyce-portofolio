...
const appCss = "/joyce-portfolio/assets/styles-DtE__SSw.css";
...
const $$splitComponentImporter$2 = () => import("./visuels-CjwEovQI.js");
const Route$2 = createFileRoute("/visuels")({
  head: () => ({
    meta: [{
      title: "Galerie de visuels — WANDJA Joyce"
    }, {
      name: "description",
      content: "Sélection de visuels créés pour les pages clients lors de mon stage chez CJM Digital Agency."
    }, {
      property: "og:title",
      content: "Galerie de visuels — WANDJA Joyce"
    }, {
      property: "og:description",
      content: "Création graphique pour réseaux sociaux : publications, flyers et templates."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-_Qz1Jpa6.js");
const Route$1 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio de WANDJA Joyce, ingénieure en génie logiciel, analyste UML, développeuse web et stratège marketing digital basée à Douala, Cameroun."
    }, {
      property: "og:title",
      content: "WANDJA Joyce — Tech × Marketing Digital"
    }, {
      property: "og:description",
      content: "Conception de systèmes intelligents et de solutions digitales performantes adaptées aux entreprises africaines."
    }]
  })
});
...
const tablebookLogin = "/joyce-portfolio/assets/01-login-DR_CDotv.png";
const tablebookAccueil = "/joyce-portfolio/assets/02-accueil-BBX6JRJD.png";
const tablebookRestaurants = "/joyce-portfolio/assets/03-restaurants-DbCK1XQv.png";
const tablebookDetail = "/joyce-portfolio/assets/04-detail-restaurant-X-gpkPeg.png";
const vpUsecaseGlobal = "/joyce-portfolio/assets/01-usecase-global-14PkEO5y.png";
const vpUsecaseGerer = "/joyce-portfolio/assets/02-usecase-gerer-demande-9qtQmn3k.png";
const vpClasse = "/joyce-portfolio/assets/03-diagramme-classe-Dn-kI9PP.png";
const vpActSoumettre = "/joyce-portfolio/assets/04-activite-soumettre-demande-JL9EJy-a.png";
const vpActGerer = "/joyce-portfolio/assets/05-activite-gerer-conge-fZG6Y_ho.png";
const vpSeqSoumettre = "/joyce-portfolio/assets/06-sequence-soumettre-demande-DP33UiPG.png";
const vpSeqGerer = "/joyce-portfolio/assets/07-sequence-gerer-conge-NUlvLPJl.png";
const cgAccueil = "/joyce-portfolio/assets/01-accueil-BGe6Mes4.jpg";
const cgAbonnement = "/joyce-portfolio/assets/02-abonnement-BHk_qkkK.png";
const cgCreation = "/joyce-portfolio/assets/03-creation-compte-TA1ixldo.jpg";
const cgSuperAdmin = "/joyce-portfolio/assets/04-super-admin-DBn-LY1m.jpg";
const cgTableauBord = "/joyce-portfolio/assets/05-tableau-bord-admin-BYXUYMFR.jpg";
const cgPortail = "/joyce-portfolio/assets/06-portail-employe-CpbrCXze.jpg";
const techProjects = [
  {
    slug: "table-book",
    icon: UtensilsCrossed,
    title: "Table Book",
    problem: "À Yaoundé, les nouveaux arrivants peinent à trouver un restaurant adapté à leurs goûts et à réserver une table sans devoir se déplacer ou multiplier les appels.",
    solution: "Une plateforme web de réservation qui centralise les restaurants de la ville, leurs spécialités, horaires, localisation et la disponibilité des tables, avec un parcours de réservation en ligne simple et rapide.",
    value: "Une expérience fluide pour les clients et plus de visibilité pour les restaurants locaux — la restauration camerounaise se digitalise.",
    tech: ["HTML", "CSS", "JavaScript", "Python", "MySQL"],
    accent: "from-primary/20 to-primary-glow/10",
    cover: tablebookAccueil,
    context: "Projet personnel conçu pour répondre à un besoin réel des habitants et visiteurs de Yaoundé : trouver et réserver un restaurant en quelques clics.",
  ...
  },
  {
    ...
    problem: "Vision Pub, une petite entreprise, gérait les congés de ses employés de façon manuelle, ce qui rendait difficile le suivi précis des congés, entraînait des pertes de données et affectait la productivité.",
    solution: "Analyse et conception complète d'un système de gestion des congés : modélisation UML détaillée (cas d'utilisation, classes, séquences, activités) avec PowerAMC, et rédaction des spécifications fonctionnelles et techniques répondant aux besoins réels de Vision Pub.",
    value: "Une étude rigoureuse qui automatise le processus, centralise les informations et augmente la transparence dans la gestion des congés des employés.",
    tech: ["UML", "PowerAMC", "Analyse fonctionnelle", "Modélisation"],
    accent: "from-accent/20 to-primary/10",
    cover: vpUsecaseGlobal,
    context: "Projet d'analyse et de conception réalisé pour Vision Pub, une petite entreprise camerounaise, afin de poser les bases d'une future application web de gestion des congés.",
  ...
  },
  {
    ...
    problem: "Les PME peinent à gérer les congés de leurs employés : processus manuels, erreurs de suivi, manque de visibilité sur les soldes et lenteur des validations RH.",
    solution: "Plateforme SaaS multi-entreprise avec workflow d'approbation, soldes automatiques, portails personnalisés employé/admin/super-admin, plans d'abonnement et notifications SMS via Twilio.",
    value: "Gain de temps, transparence et fiabilité dans la gestion des congés — chaque entreprise dispose de son propre espace personnalisé.",
    tech: ["Django", "Python", "HTML", "CSS", "Bootstrap", "Twilio"],
    accent: "from-primary/20 to-accent/10",
    cover: cgAccueil,
    context: "Application web SaaS de gestion des congés permettant à plusieurs entreprises de souscrire, créer leurs comptes et gérer indépendamment les congés de leurs employés.",
...
const $$splitComponentImporter = () => import("./projets._slug-aQ3E5Uix.js");
const $$splitErrorComponentImporter = () => import("./projets._slug-iUkaocui.js");
const $$splitNotFoundComponentImporter = () => import("./projets._slug-C9FQCgKg.js");
const Route2 = createFileRoute("/projets/$slug")({
  loader: ({
    params
  }) => {
...
const VisuelsRoute = Route$2.update({
  id: "/visuels",
  path: "/visuels",
...
const ProjetsSlugRoute = Route2.update({
  id: "/projets/$slug",
  path: "/projets/$slug",
  getParentRoute: () => Route$3
});
