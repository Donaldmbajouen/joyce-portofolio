...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CrlVJRUD.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CfQW7UgC.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "joyce-portfolio";
var SERVER_FN_BASE = "/joyce-portfolio/_serverFn/";
